...
public final class SqlRequest {
    ...
    public static final String USER_CREATE = "INSERT INTO user (access, login, password, " +
    ...
    public static final String UPDATE_ACCESS = "UPDATE user SET access =? WHERE id =?";
    ...
    public static final String CREATE_MOVIE = "INSERT INTO movie (movie_title, show_date, show_time, " +
